...
var HotkeysPlus = /** @class */ (function (_super) {
  ...
  HotkeysPlus.prototype.replaceListElement = function (
    match,
    spaces,
    startText,
    sentence
  ...
  HotkeysPlus.prototype.replaceTodoElement = function (
    match,
    spaces,
    startText,
    sentence
