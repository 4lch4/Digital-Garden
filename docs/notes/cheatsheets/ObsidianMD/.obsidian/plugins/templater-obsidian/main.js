  ...
  display() {
          ...
          .onChange(new_value => {
            ...
            if (isNaN(new_timeout)) {
              this.plugin.log_error(
                new TemplaterError('Timeout must be a number')
              )
              return
            }
    ...
    if (this.plugin.settings.trigger_on_file_creation) {
      ...
      new obsidian.Setting(containerEl)
        ...
        .addText(text => {
          text
            .setPlaceholder('folder 1/template_file')
...
function getWholeFilePath(name, parentfile, isDirectory) {
  var includePath =
    path__namespace.resolve(
      isDirectory ? parentfile : path__namespace.dirname(parentfile), // returns directory the parent file is in
      name // file
  ...
  generateContext(config) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return Object.assign(
        Object.assign({}, this.static_context),
...
class InternalModuleFile extends InternalModule {
  ...
  generate_create_new() {
    return (template, filename, open_new = false, folder) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const new_file =
          yield this.plugin.templater.create_new_note_from_template(
            template,
            folder,
            filename,
            open_new
    ...
    return include_link =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const parsed_content =
          yield this.plugin.templater.parser.parseTemplates(inc_file_content)
        this.include_depth -= 1
  ...
  generate_move() {
    return path =>
      __awaiter(this, void 0, void 0, function* () {
        const new_path = obsidian.normalizePath(
...
class InternalModuleWeb extends InternalModule {
  ...
  generate_random_picture() {
    return (size, query) =>
      __awaiter(this, void 0, void 0, function* () {
        let response = yield this.getRequest(
          `https://source.unsplash.com/random/${
            size !== null && size !== void 0 ? size : ''
...
class PromptModal extends obsidian.Modal {
  ...
  createForm() {
    ...
    this.promptEl.value =
      (_a = this.default_value) !== null && _a !== void 0 ? _a : ''
...
class InternalModuleSystem extends InternalModule {
  ...
  generate_suggester() {
    return (text_items, items, throw_on_cancel = false, placeholder = '') =>
      __awaiter(this, void 0, void 0, function* () {
...
class UserTemplateParser {
  ...
  setup() {
    if (
      ...
      !(this.app.vault.adapter instanceof obsidian.FileSystemAdapter)
    ) {
      this.cwd = ''
    } else {
  ...
  generate_user_script_functions(config) {
    return __awaiter(this, void 0, void 0, function* () {
      let files = getTFilesFromFolder(
        this.app,
        this.plugin.settings.script_folder
      )
  ...
  load_user_script_function(config, file) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const user_function = yield Promise.resolve().then(function () {
        return /*#__PURE__*/ _interopNamespace(require(file_path))
      })
  ...
  generate_system_command_user_functions(config) {
    return __awaiter(this, void 0, void 0, function* () {
      const context = yield this.plugin.templater.parser.generateContext(
        config,
        ContextMode.INTERNAL
      )
      for (let [template, cmd] of this.plugin.settings.templates_pairs) {
        ...
        if (obsidian.Platform.isMobileApp) {
          ...
          this.user_system_command_functions.set(template, user_args =>
            __awaiter(this, void 0, void 0, function* () {
              const process_env = Object.assign(
                Object.assign({}, process.env),
                user_args
              )
              const cmd_options = Object.assign(
                {
...
class TemplateParser {
  constructor(app, plugin) {
    this.app = app
    this.plugin = plugin
    this.internalTemplateParser = new InternalTemplateParser(
      this.app,
      this.plugin
    )
  ...
  generateContext(config, context_mode = ContextMode.USER_INTERNAL) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const internal_context =
        yield this.internalTemplateParser.generateContext(config)
      let user_context = {}
      ...
      switch (context_mode) {
        ...
        case ContextMode.USER_INTERNAL:
          ...
          Object.assign(
            context,
            Object.assign(Object.assign({}, internal_context), {
              user: user_context
            })
          )
          break
...
class Templater {
  ...
  create_new_note_from_template(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const created_note = yield this.app.fileManager.createNewMarkdownFile(
        folder,
        filename !== null && filename !== void 0 ? filename : 'Untitled'
      )
      let running_config
      let output_content
      if (template instanceof obsidian.TFile) {
        ...
        output_content = yield this.plugin.errorWrapper(() =>
          __awaiter(this, void 0, void 0, function* () {
  ...
  append_template(template_file) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const output_content = yield this.plugin.errorWrapper(() =>
        __awaiter(this, void 0, void 0, function* () {
          return this.read_and_parse_template(running_config)
        })
      )
      ...
      while ((node = walker.nextNode())) {
        ...
        if ((match = dynamic_command_regex.exec(content)) != null) {
          ...
          if (!pass) {
            ...
            yield this.parser.setCurrentContext(
              running_config,
          ...
          while (match != null) {
            ...
            const command_output = yield this.plugin.errorWrapper(() =>
              __awaiter(this, void 0, void 0, function* () {
        ...
        function (config, parserConfig) {
          const templaterOverlay = {
            startState: function () {
              ...
              return Object.assign(Object.assign({}, js_state), {
                inCommand: false,
                tag_class: '',
                freeLine: false
              })
            ...
            copyState: function (state) {
              const js_state = window.CodeMirror.startState(js_mode)
              const new_state = Object.assign(Object.assign({}, js_state), {
  ...
  onload() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.registerMarkdownPostProcessor((el, ctx) =>
        this.templater.process_dynamic_templates(el, ctx)
      )
    ...
    if (this.settings.trigger_on_file_creation) {
      this.trigger_on_file_creation_event = this.app.vault.on('create', file =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const template_folder = obsidian.normalizePath(
          ...
          if (file.stat.size == 0 && this.settings.empty_file_template) {
            const template_file = yield this.errorWrapper(() =>
              __awaiter(this, void 0, void 0, function* () {
                return resolveTFile(
                  this.app,
                  this.settings.empty_file_template + '.md'
                )
              })
            )
            if (!template_file) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (!(e instanceof TemplaterError)) {
          this.log_error(
            new TemplaterError(`Template parsing error, aborting.`, e.message)
          )
        } else {
          this.log_error(e)
        }
