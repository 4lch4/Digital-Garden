...
var DatePickerModal = /** @class */ (function (_super) {
  ...
  function DatePickerModal(app, plugin) {
    ...
    _this.plugin = plugin
    _this.activeView = _this.app.workspace.getActiveViewOfType(
...
var years = createCommonjsModule(function (module, exports) {
  ...
  function findYearClosestToRef(refDate, day, month) {
    ...
    if (
      Math.abs(nextYear.diff(refMoment)) < Math.abs(dateMoment.diff(refMoment))
    ) {
      dateMoment = nextYear
    } else if (
      Math.abs(lastYear.diff(refMoment)) < Math.abs(dateMoment.diff(refMoment))
    ) {
      dateMoment = lastYear
    }
...
var constants$5 = createCommonjsModule(function (module, exports) {
  ...
  const SINGLE_TIME_UNIT_PATTERN = `(${
    exports.NUMBER_PATTERN
  })\\s{0,5}(${pattern.matchAnyPattern(exports.TIME_UNIT_DICTIONARY)})\\s{0,5}`
...
var results = createCommonjsModule(function (module, exports) {
  ...
  class ParsingComponents {
    ...
    isValidDate() {
      const date = this.isCertain('timezoneOffset')
    ...
    date() {
      ...
      return new Date(
        date.getTime() + this.getTimezoneAdjustmentMinute(date) * 60000
      )
    }
    ...
    getTimezoneAdjustmentMinute(date) {
      ...
      const targetTimezoneOffset =
        (_a = this.get('timezoneOffset')) !== null && _a !== void 0
          ? _a
...
var AbstractParserWithWordBoundary = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ENTimeUnitWithinFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  const PATTERN_WITH_PREFIX = new RegExp(
    `(?:within|in|for)\\s*` +
      `(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(${constants$5.TIME_UNITS_PATTERN})(?=\\W|$)`,
    'i'
  )
  ...
  class ENTimeUnitWithinFormatParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
      ...
      return results.ParsingComponents.createRelativeFromRefDate(
        context.refDate,
        timeUnits
      )
    }
...
var ENMonthNameLittleEndianParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ENMonthNameMiddleEndianParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ENMonthNameParser_1 = createCommonjsModule(function (module, exports) {
  ...
  class ENMonthNameParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
      ...
      if (
        match[0].length <= 3 &&
        !constants$5.FULL_MONTH_NAME_DICTIONARY[monthName]
      ) {
        return null
      }
...
var ENCasualYearMonthDayParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ENSlashMonthFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var AbstractTimeExpressionParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ENTimeUnitAgoFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  const PATTERN = new RegExp(
    '' +
      '(' +
      constants$5.TIME_UNITS_PATTERN +
      ')' +
      '(?:ago|before|earlier)(?=(?:\\W|$))',
    'i'
  )
  const STRICT_PATTERN = new RegExp(
    '' + '(' + constants$5.TIME_UNITS_PATTERN + ')' + 'ago(?=(?:\\W|$))',
    'i'
  )
...
var ENTimeUnitLaterFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  class MergingRefiner {
    refine(context, results) {
      ...
      for (let i = 1; i < results.length; i++) {
        ...
        if (
          !this.shouldMergeResults(textBetween, curResult, nextResult, context)
        ) {
...
var AbstractMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ENMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
  ...
  Object.defineProperty(exports, '__esModule', { value: true })
  const AbstractMergeDateRangeRefiner_1$1 = __importDefault(
    AbstractMergeDateRangeRefiner_1
  )
...
var mergingCalculation = createCommonjsModule(function (module, exports) {
  ...
  function mergeDateTimeComponent(dateComponent, timeComponent) {
    ...
    if (
      dateTimeComponent.get('meridiem') == dist.Meridiem.PM &&
...
var AbstractMergeDateTimeRefiner = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var ExtractTimezoneAbbrRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  class ExtractTimezoneAbbrRefiner {
    ...
    refine(context, results) {
      ...
      const timezoneOverrides =
        (_a = context.option.timezones) !== null && _a !== void 0 ? _a : {}
...
var ExtractTimezoneOffsetRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var MergeWeekdayComponentRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var configurations = createCommonjsModule(function (module, exports) {
  ...
  const ExtractTimezoneAbbrRefiner_1$1 = __importDefault(
    ExtractTimezoneAbbrRefiner_1
  )
  const ExtractTimezoneOffsetRefiner_1$1 = __importDefault(
    ExtractTimezoneOffsetRefiner_1
  )
  ...
  function includeCommonConfiguration(configuration, strictMode = false) {
    ...
    configuration.refiners.push(
      new UnlikelyFormatFilter_1$1.default(strictMode)
    )
...
var ENCasualDateParser_1 = createCommonjsModule(function (module, exports) {
  ...
  const PATTERN =
    /(now|today|tonight|tomorrow|tmr|yesterday|last\s*night)(?=\W|$)/i
...
var ENCasualTimeParser_1 = createCommonjsModule(function (module, exports) {
  ...
  const PATTERN =
    /(?:this)?\s*(morning|afternoon|evening|night|midnight|noon)(?=\W|$)/i
...
var ENRelativeDateFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
  ...
  const PATTERN = new RegExp(
    `(this|next|last|past)\\s*(${pattern.matchAnyPattern(
      constants$5.TIME_UNIT_DICTIONARY
    )})(?=\\s*)` + '(?=\\W|$)',
    'i'
  )
...
var ENTimeUnitCasualRelativeFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  const PATTERN = new RegExp(
    `(this|last|past|next|\\+|-)\\s*(${constants$5.TIME_UNITS_PATTERN})(?=\\W|$)`,
    'i'
  )
...
var en = createCommonjsModule(function (module, exports) {
  ...
  exports.createConfiguration =
    ...
    exports.casual =
      void 0
  const ENTimeUnitWithinFormatParser_1$1 = __importDefault(
    ENTimeUnitWithinFormatParser_1
  )
  const ENMonthNameLittleEndianParser_1$1 = __importDefault(
    ENMonthNameLittleEndianParser_1
  )
  const ENMonthNameMiddleEndianParser_1$1 = __importDefault(
    ENMonthNameMiddleEndianParser_1
  )
  const ENMonthNameParser_1$1 = __importDefault(ENMonthNameParser_1)
  const ENCasualYearMonthDayParser_1$1 = __importDefault(
    ENCasualYearMonthDayParser_1
  )
  const ENSlashMonthFormatParser_1$1 = __importDefault(
    ENSlashMonthFormatParser_1
  )
  const ENTimeExpressionParser_1$1 = __importDefault(ENTimeExpressionParser_1)
  const ENTimeUnitAgoFormatParser_1$1 = __importDefault(
    ENTimeUnitAgoFormatParser_1
  )
  const ENTimeUnitLaterFormatParser_1$1 = __importDefault(
    ENTimeUnitLaterFormatParser_1
  )
  ...
  const ENRelativeDateFormatParser_1$1 = __importDefault(
    ENRelativeDateFormatParser_1
  )

  const SlashDateFormatParser_1$1 = __importDefault(SlashDateFormatParser_1)
  const ENTimeUnitCasualRelativeFormatParser_1$1 = __importDefault(
    ENTimeUnitCasualRelativeFormatParser_1
  )
  ...
  function createCasualConfiguration(littleEndian = false) {
    ...
    option.parsers.unshift(
      new ENTimeUnitCasualRelativeFormatParser_1$1.default()
    )
    return option
  }
...
var DEMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
...
var DECasualDateParser_1 = createCommonjsModule(function (module, exports) {
  ...
  class DECasualDateParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
      ...
      if (timeKeyword) {
        component = DECasualTimeParser_1$1.default.extractTimeComponents(
          component,
          timeKeyword
        )
      }
...
var DEMonthNameLittleEndianParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var de = createCommonjsModule(function (module, exports) {
  ...
  const DECasualTimeParser_1$1 = __importDefault(DECasualTimeParser_1)
  const DEMonthNameLittleEndianParser_1$1 = __importDefault(
    DEMonthNameLittleEndianParser_1
  )
    ...
    return configurations.includeCommonConfiguration(
      {
        ...
        refiners: [
          new DEMergeDateRangeRefiner_1$1.default(),
          new DEMergeDateTimeRefiner_1$1.default()
        ]
      },
      strictMode
    )
...
var FRMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
...
var FRSpecificTimeExpressionParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var FRMonthNameLittleEndianParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  class FRMonthNameLittleEndianParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
      const result = context.createParsingResult(match.index, match[0])
      const month =
        constants$3.MONTH_DICTIONARY[match[MONTH_NAME_GROUP].toLowerCase()]
      const day = constants_3.parseOrdinalNumberPattern(match[DATE_GROUP])
      if (day > 31) {
        match.index = match.index + match[DATE_GROUP].length
        return null
...
var FRTimeUnitAgoFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  class FRTimeUnitAgoFormatParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    ...
    innerPattern() {
      return new RegExp(
        `il y a\\s*(${constants$3.TIME_UNITS_PATTERN})(?=(?:\\W|$))`,
        'i'
      )
    }
    innerExtract(context, match) {
...
var FRTimeUnitWithinFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  class FRTimeUnitWithinFormatParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    innerPattern() {
      return new RegExp(
        `(?:dans|en|pour|pendant)\\s*(${constants$3.TIME_UNITS_PATTERN})(?=\\W|$)`,
        'i'
      )
    }
    innerExtract(context, match) {
...
var FRTimeUnitRelativeFormatParser = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var fr = createCommonjsModule(function (module, exports) {
  ...
  const FRSpecificTimeExpressionParser_1$1 = __importDefault(
    FRSpecificTimeExpressionParser_1
  )
  const FRMonthNameLittleEndianParser_1$1 = __importDefault(
    FRMonthNameLittleEndianParser_1
  )
  const FRTimeUnitAgoFormatParser_1$1 = __importDefault(
    FRTimeUnitAgoFormatParser_1
  )
  const FRTimeUnitWithinFormatParser_1$1 = __importDefault(
    FRTimeUnitWithinFormatParser_1
  )
    ...
    return configurations.includeCommonConfiguration(
      {
        ...
        refiners: [
          new FRMergeDateTimeRefiner_1$1.default(),
          new FRMergeDateRangeRefiner_1$1.default()
        ]
      },
      strictMode
    )
  ...
  class JPStandardParser {
    ...
    extract(context, match) {
      ...
      if (match[TYPICAL_YEAR_GROUP]) {
        ...
        let year =
          yearNumText == '元' ? 1 : parseInt(constants$2.toHankaku(yearNumText))
...
var JPMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
...
var PTMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
...
var PTMonthNameLittleEndianParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
  ...
  class PTMonthNameLittleEndianParser extends AbstractParserWithWordBoundary.AbstractParserWithWordBoundaryChecking {
    ...
    innerExtract(context, match) {
      const result = context.createParsingResult(match.index, match[0])
      const month =
        constants$1.MONTH_DICTIONARY[match[MONTH_NAME_GROUP].toLowerCase()]
      const day = parseInt(match[DATE_GROUP])
      if (day > 31) {
        match.index = match.index + match[DATE_GROUP].length
        return null
...
var pt = createCommonjsModule(function (module, exports) {
  ...
  const PTMonthNameLittleEndianParser_1$1 = __importDefault(
    PTMonthNameLittleEndianParser_1
  )
    ...
    return configurations.includeCommonConfiguration(
      {
        ...
        refiners: [
          new PTMergeDateTimeRefiner_1$1.default(),
          new PTMergeDateRangeRefiner_1$1.default()
        ]
      },
      strictMode
    )
...
var NLMergeDateRangeRefiner_1 = createCommonjsModule(function (
  module,
  exports
) {
  var __importDefault =
...
var NLTimeUnitWithinFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var NLMonthNameMiddleEndianParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var NLSlashMonthFormatParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var NLCasualYearMonthDayParser_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
...
var nl = createCommonjsModule(function (module, exports) {
  ...
  const SlashDateFormatParser_1$1 = __importDefault(SlashDateFormatParser_1)
  const NLTimeUnitWithinFormatParser_1$1 = __importDefault(
    NLTimeUnitWithinFormatParser_1
  )
  const NLWeekdayParser_1$1 = __importDefault(NLWeekdayParser_1)
  const NLMonthNameMiddleEndianParser_1$1 = __importDefault(
    NLMonthNameMiddleEndianParser_1
  )
  const NLMonthNameParser_1$1 = __importDefault(NLMonthNameParser_1)
  const NLSlashMonthFormatParser_1$1 = __importDefault(
    NLSlashMonthFormatParser_1
  )
  const NLTimeExpressionParser_1$1 = __importDefault(NLTimeExpressionParser_1)
  const NLCasualYearMonthDayParser_1$1 = __importDefault(
    ...
    return configurations.includeCommonConfiguration(
      {
        ...
        refiners: [
          new NLMergeDateTimeRefiner_1$1.default(),
          new NLMergeDateRangeRefiner_1$1.default()
        ]
      },
      strictMode
    )
...
var NLDSettingsTab = /** @class */ (function (_super) {
  ...
  NLDSettingsTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        'Input dates with natural language. Open the suggest menu with ' +
          this.plugin.settings.autocompleteTriggerPhrase
      )
...
var CodeMirrorSuggest = /** @class */ (function () {
  ...
  CodeMirrorSuggest.prototype.setInstructions = function (
...
var DateSuggest = /** @class */ (function (_super) {
  ...
  function DateSuggest(app, plugin) {
    var _this =
      _super.call(this, app, plugin.settings.autocompleteTriggerPhrase) || this
    _this.plugin = plugin
  ...
  DateSuggest.prototype.getDateSuggestions = function (inputStr) {
    if (inputStr.match(/(next|last|this)/i)) {
      ...
      return [
        ...
        .map(function (val) {
          return { label: reference_1 + ' ' + val }
        })
        .filter(function (items) {
          return items.label.toLowerCase().startsWith(inputStr)
        })
    }
    var relativeDate =
...
var NaturalLanguageDates = /** @class */ (function (_super) {
  ...
  function NaturalLanguageDates() {
    ...
    _this.autosuggestHandler = function (cmEditor, changeObj) {
      var _a
      return (_a = _this.autosuggest) === null || _a === void 0
        ? void 0
        : _a.update(cmEditor, changeObj)
    }
    return _this
  }
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            this.addCommand({
              ...
              callback: function () {
                return _this.onTrigger('replace')
              },
              hotkeys: []
            })
            this.addCommand({
  ...
  NaturalLanguageDates.prototype.onTrigger = function (mode) {
    var activeView = this.app.workspace.getActiveViewOfType(
      obsidian.MarkdownView
    )
    if (!activeView) {
      return
  ...
  NaturalLanguageDates.prototype.adjustCursor = function (
    editor,
    cursor,
    newStr,
    oldStr
  ...
  NaturalLanguageDates.prototype.insertDateString = function (
    dateString,
    editor,
    _cursor
  ) {
