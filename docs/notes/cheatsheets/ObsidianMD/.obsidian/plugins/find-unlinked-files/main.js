...
var SettingsTab = /** @class */ (function (_super) {
  ...
  SettingsTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        'Enable to ignore files in the given directories. Disable to only include files in the given filetypes'
      )
      .addToggle(function (cb) {
        return cb
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        'Ignore files, which contain the given tag. Add each tag separated by comma (without `#`)'
      )
      .addTextArea(function (cb) {
        return cb
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        'Ignore links in files in the specified directory. Add each directory path in a new line'
      )
      .addTextArea(function (cb) {
        return cb
          .setPlaceholder('Directory/Subdirectory')
          .setValue(
            _this.plugin.settings.unresolvedLinksDirectoriesToIgnore.join('\n')
          )
          .onChange(function (value) {
            var paths = value
              .trim()
    ...
    new obsidian.Setting(containerEl)
      .setName('Files to ignore.')
      .setDesc(
        'Ignore links in the specified file. Add each file path in a new line (with file extension!)'
      )
      .addTextArea(function (cb) {
        return cb
          .setPlaceholder('Directory/file.md')
          .setValue(
            _this.plugin.settings.unresolvedLinksFilesToIgnore.join('\n')
          )
          .onChange(function (value) {
            var paths = value
              .trim()
    ...
    new obsidian.Setting(containerEl)
      ...
      .addTextArea(function (cb) {
        return cb
          .setPlaceholder('Directory/file.md')
          .setValue(
            _this.plugin.settings.unresolvedLinksLinksToIgnore.join('\n')
          )
          .onChange(function (value) {
            var paths = value
              .trim()
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        'Ignore links with the specified filetype. Add each filetype separated by comma'
      )
      .addTextArea(function (cb) {
        return cb
          .setPlaceholder('docx,txt')
          .setValue(
            _this.plugin.settings.unresolvedLinksFileTypesToIgnore.join(',')
          )
          .onChange(function (value) {
            var extensions = value.trim().split(',')
...
var Utils = /** @class */ (function () {
  ...
  Utils.prototype.hasLinksToIgnore = function () {
    ...
    var _a, _b
    if (
      (((_a = this.fileCache) === null || _a === void 0 ? void 0 : _a.embeds) !=
        null ||
        ((_b = this.fileCache) === null || _b === void 0 ? void 0 : _b.links) !=
          null) &&
    ...
    return obsidian.iterateCacheRefs(this.fileCache, function (cb) {
      var _a
      var link =
        (_a = _this.app.metadataCache.getFirstLinkpathDest(
          cb.link,
          _this.filePath
        )) === null || _a === void 0
          ? void 0
  ...
  Utils.prototype.checkDirectory = function () {
    ...
    var contains =
      this.directoriesToIgnore.find(function (value) {
        return _this.filePath.startsWith(value) && value.length != 0
      }) !== undefined
...
var FindUnlinkedFilesPlugin = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            this.addSettingTab(
              new SettingsTab(this.app, this, DEFAULT_SETTINGS)
            )
            return [2 /*return*/]
        }
      })
  ...
  FindUnlinkedFilesPlugin.prototype.findUnlinkedFiles = function () {
    ...
    markdownFiles.forEach(function (markFile) {
      ...
      obsidian.iterateCacheRefs(
        _this.app.metadataCache.getFileCache(markFile),
        function (cb) {
          var txt = _this.app.metadataCache.getFirstLinkpathDest(
            obsidian.getLinkpath(cb.link),
            markFile.path
          )
    ...
    var notLinkedFiles = files.filter(function (file) {
      return _this.isValid(file, links)
    })
    ...
    notLinkedFiles.forEach(function (file) {
      text +=
        prefix +
        '- [[' +
        _this.app.metadataCache.fileToLinktext(file, '/') +
        ']]\n'
    })
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            links =
              (_b =
                (_a = this.app.metadataCache.getCache(
                  this.settings.outputFileName + '.md'
                )) === null || _a === void 0
                  ? void 0
            ...
            links.forEach(function (link) {
              var file = _this.app.metadataCache.getFirstLinkpathDest(
                link.link,
                '/'
              )
              if (!file) return
  ...
  FindUnlinkedFilesPlugin.prototype.findUnresolvedLinks = function () {
    ...
    for (var filePath in unresolvedLinks) {
      ...
      var _loop_1 = function (link) {
        ...
        if (
          this_1.settings.unresolvedLinksFileTypesToIgnore.contains(
            linkFileType
          )
        )
          return 'continue'
  ...
  FindUnlinkedFilesPlugin.prototype.isValid = function (file, links) {
    ...
    if (this.settings.fileTypesToIgnore[0] !== '') {
      var containsFileType = this.settings.fileTypesToIgnore.contains(
        file.extension
      )
