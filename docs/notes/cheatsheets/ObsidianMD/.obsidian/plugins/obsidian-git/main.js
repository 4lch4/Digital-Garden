...
var child_process_1__default =
  /*#__PURE__*/ _interopDefaultLegacy(child_process_1)
                    ...
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [
                            4 /*yield*/,
                            plugin.gitManager.checkout(option)
                          ]
                        case 1:
                          _a.sent()
...
var ConfigList_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.configGetParser =
    exports.configListParser =
    exports.ConfigList =
      void 0
  ...
  function taskCallback(task, response, callback = utils.NOOP) {
    ...
    const onError = err => {
      if ((err === null || err === void 0 ? void 0 : err.task) === task) {
        callback(
          err instanceof gitResponseError.GitResponseError
...
var simpleGitApi = createCommonjsModule(function (module, exports) {
  ...
  class SimpleGitApi {
    ...
    cwd(directory) {
      ...
      if (
        typeof (directory === null || directory === void 0
          ? void 0
...
const { branchTask, branchLocalTask, deleteBranchesTask, deleteBranchTask } =
  branch
...
var gitFactory = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.gitInstanceFactory =
    exports.gitExportFactory =
  ...
  function gitInstanceFactory(baseDir, options) {
    ...
    config.spawnOptions &&
      plugins$1.add(plugins.spawnOptionsPlugin(config.spawnOptions))
    plugins$1.add(
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          case 0:
            ...
            _d =
              'git add -A && if [ ! -z "$(git status --porcelain)" ]; then git commit -m "'
...
var ObsidianGit = /** @class */ (function (_super) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_c) {
        return [
          ...
          {
            backup: new Date(
              (_a = window.localStorage.getItem(
                this.manifest.id + ':lastAutoBackup'
              )) !== null && _a !== void 0
                ? _a
                : ''
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            new obsidian.Notice(
              "Can't find a valid git repository. Please create one"
            )
            return [3 /*break*/, 7]
          case 4:
            this.gitReady = true
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            if (status_1.conflicted.length > 0) {
              this.displayError(
                'You have ' + status_1.conflicted.length + ' conflict files'
              )
            }
            _a.label = 5
          case 5:
  ...
  ObsidianGit.prototype.startAutoPull = function (minutes) {
    ...
    this.timeoutIDPull = window.setTimeout(function () {
      ...
      ? minutes
      : this.settings.autoPullInterval) * 60000)
  }
